...
$integration
    ...
    ->addProvider(new \Leadrock\Providers\Leadrock('39', '399e054a63f77d039bef8b089a918a44'))
    ->setWebmasterLink('https://leadrock.com/URL-9ABAE-E7DF3')
...
class LeadrockIntegrationDownloader
{
    ...
    private function getErrorText()
    {
        return [
            ...
            'Or you can visit source code page and see expanded documentation: <a href="https://github.com/brntsrs/leadrock-integration/releases">https://github.com/brntsrs/leadrock-integration/releases</a>',
        ];
    }
